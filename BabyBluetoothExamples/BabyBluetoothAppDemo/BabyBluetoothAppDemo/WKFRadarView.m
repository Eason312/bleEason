...
-(void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < pulsingCount; i++) {
        ...
        pulsingLayer.backgroundColor = [UIColor colorWithRed:255/255.0 green:240/255.0 blue:60.0/255.0 alpha:1.0].CGColor;
        pulsingLayer.borderColor = [UIColor colorWithRed:255/255.0 green:240/255.0 blue:60.0/255.0 alpha:1.0].CGColor;
...
-(void)addOrReplaceItem
{
    ...
    [prButton setImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
